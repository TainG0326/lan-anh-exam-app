        ...
        <div className="flex items-center gap-3">
          <div className="relative hidden md:block">
            ...
            <input
              type="text"
              placeholder="Search..."
              className="w-56 pl-10 pr-4 py-2 rounded-xl bg-gray-100 border-0 focus:outline-none focus:ring-2 focus:ring-gray-200 text-sm placeholder:text-gray-400 transition-all duration-300"
            />
          </div>
          ...
          <button className="relative p-2 rounded-xl bg-gray-100 hover:bg-gray-200 transition-colors">
            ...
            {pendingReviews > 0 && (
              <span className="absolute -top-1 -right-1 w-4 h-4 bg-gray-900 rounded-full text-[10px] font-bold text-white flex items-center justify-center">
