      ...
      <div className="mesh-gradient min-h-screen flex items-center justify-center font-sans text-gray-800 dark:text-gray-200 transition-colors duration-300">
        <div className="w-full max-w-md p-8 sm:p-10 bg-white/80 dark:bg-gray-900/60 backdrop-blur-md shadow-xl rounded-lg border border-white/50 dark:border-gray-700/50 transition-all duration-300">
          <div className="text-center mb-10">
            <h1 className="font-serif text-4xl text-gray-900 dark:text-white mb-2 tracking-tight">Student Portal</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400 font-light tracking-wide uppercase text-xs">English Learning &amp; Online Exam System</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <div className="text-sm">
                <a className="font-medium text-[#5F8D78] hover:text-opacity-80 transition-colors" href="#">
                  Forgot password?
                </a>
              </div>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700/50 text-center space-y-2">
            <p className="text-xs font-serif text-gray-500 dark:text-gray-400 italic">For demonstration purposes:</p>
            <div className="text-xs text-gray-600 dark:text-gray-300 font-mono bg-gray-50 dark:bg-gray-800/50 py-2 px-4 rounded inline-block">
